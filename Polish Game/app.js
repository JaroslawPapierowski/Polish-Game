...
async function getData() {
    ...
    const list = document.querySelector("#wojewodztwo");
...
function rozpocznijGru() {
    var startDiv = document.getElementById("startDiv");
    startDiv.style.display = "none";

    var overlay = document.getElementById("overlay");
    overlay.style.display = "none"; // Ukryj overlay, gdy gra się rozpocznie

    var rightDiv = document.querySelector(".right");
    rightDiv.style.visibility = "visible";

    // Zresetuj grę, aktualizując wojewodztwo do odgadnięcia
    zresetujGre();
}
...
function random() {
    ...
    const listw = document.querySelector("#wojewodztwo");
